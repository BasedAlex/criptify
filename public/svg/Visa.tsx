import { CardType } from '@/components/components/CardForm/CardForm'
import React, { FC } from 'react'

const Visa: any = (props: any) => {
	return (
		<svg
			...
			<defs>
				...
				>
					<stop
						offset='0'
						style={{
							stopColor: props.typeCard === 'VISA' ? '#222357' : '#808080',
						}}
					/>
					<stop
						offset='1'
						style={{
							stopColor: props.typeCard === 'VISA' ? '#254aa5' : '#808080',
						}}
					/>
				</linearGradient>
